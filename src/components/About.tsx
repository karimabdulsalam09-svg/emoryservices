    ...
    <section id="about" className="py-20 relative">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p>
              I'm the founder of Emory — a creator-operations partner built for serious creators
              who want to turn attention into revenue without drowning in backend work.
            </p>
            <p>Most creators know exactly what their audience wants, but don't have the time, structure, or systems to turn that demand into a scalable digital product. Emory exists to remove that friction entirely.</p>
            <p>
            ...
            <p className="text-foreground font-semibold">
              ...
              Emory builds the system that makes it happen — efficiently, intelligently, and with zero
              operational drag.
            </p>
          </motion.div>
        </div>
