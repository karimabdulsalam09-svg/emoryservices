      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center">
            What Your <span className="text-gradient-red-orange">15-Minute Strategy Session</span> Includes:
          </h2>
          ...
          <div className="elite-card rounded-2xl p-8 md:p-12 space-y-6">
            {callPoints.map((point, index) => (
              ...
              >
                <div className="w-6 h-6 rounded-full gradient-red-orange flex items-center justify-center flex-shrink-0 mt-1">
